package com.fengjunzi.algorithms;//中位数是有序整数列表中的中间值。如果列表的大小是偶数，则没有中间值，中位数是两个中间值的平均值。
//
// 
...
// 
//
// Related Topics 设计 双指针 数据流 排序 堆（优先队列） 👍 1163 👎 0
...
class MedianFinder {
    ...
    public MedianFinder() {
        maxHeap = new PriorityQueue<>((a, b) -> b - a); // 降序
